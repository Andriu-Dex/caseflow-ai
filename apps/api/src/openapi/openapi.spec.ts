  ...
  it('documents exactly the implemented routes and methods', async () => {
    ...
    expect(routes).toEqual(
      [
        ...
        'POST /projects/{projectId}/diagrams/use-cases/{diagramId}/versions',
        ...
        'GET /projects/{projectId}/diagrams/use-cases',
        ...
        'POST /projects/{projectId}/sources/{sourceId}/archive',
  ...
  it('describes the API with a stable version and unique operation ids', async () => {
    ...
    expect(ids.sort()).toEqual(
      [
        ...
        'createManualUseCaseDiagramVersion',
        'createDataModel',
